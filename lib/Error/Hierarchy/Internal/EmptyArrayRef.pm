package Error::Hierarchy::Internal::EmptyArrayRef;
use warnings;
use strict;
...
Error::Hierarchy::Internal::EmptyArrayRef - when you expected a non-empty array ref

=head1 SYNOPSIS

  Error::Hierarchy::Internal::EmptyArrayRef->throw;

=head1 DESCRIPTION

This class implements an exception that is meant to be thrown when you
expected a non-empty array reference but got an empty one.
...
Error::Hierarchy::Internal::EmptyArrayRef inherits from
L<Error::Hierarchy::Internal::CustomMessage>.
