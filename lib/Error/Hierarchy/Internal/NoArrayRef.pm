...
Error::Hierarchy::Internal::NoArrayRef - when you expected an array ref

=head1 SYNOPSIS

  Error::Hierarchy::Internal::NoArrayRef->throw;
...
Error::Hierarchy::Internal::NoArrayRef inherits from
L<Error::Hierarchy::Internal::CustomMessage>.
